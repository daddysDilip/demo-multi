...
function getDelete(id) {
  $.get(mainurl+'/cartdelete/'+id, function(response){
    ...
    {
      $('#emptycart').html(EmptyCartlang);
      $('.my-cart-wrap .row').html('<div class="col-md-12"><h4 class="f-20">'+EmptyCartlang+'</h4><a href="'+mainurl+'" class="add-cart shopping-btn f-12 text-white">'+ContinueShopping+'</a></div>');
