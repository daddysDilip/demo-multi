...
function getDelete(id) {
  $.get(mainurl+'/cartdelete/'+id, function(response){
    ...
    if(rowCount == 0)
    {
      ...
      $('#emptycart').html(EmptyCartlang);
      $('#wishlist').html('<div class="container"><div class="row"><h5>'+EmptyCartlang+'</h5><div class="add-cart shopping-btn f-12"><a href="'+mainurl+'" class="text-white">'+ContinueShopping+'</a></div></div></div>');
