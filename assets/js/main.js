(function ($) {
            ...
            $.each(response, function(i, cart){
                ...
                $.each(cart, function (index, data) {
                   ...
                   // alert(total);
                    ...
                    $("#goCart").append('<div class="cart-entry"> <div class="content"> <a class="title" href="'+url+'">'+data.title+'</a> <div class="quantity">'+Quantitylang+': '+data.quantity+'</div>'+str+''+str1+'<div class="price">'+Pricelang+':' +currency+Number(data.cost).toFixed(2)+'</div></div><div class="button-x"><i class="fa fa-close" onclick=" getDelete('+data.product+')"></i></div></div>');
    ...
    function getDelete(id) {
        $.get(mainurl+'/cartdelete/'+id, function(response){
            ...
            var str = '';
            var str1 = '';
            var rowCount = $('.shopping_cart_table tbody tr').length;

            $("#goCart").html('');
            if(rowCount == 0)
            {
                $('.shopping_cart_table').html('<div class="col-md-12 col-sm-12"><h4>'+EmptyCartlang+'</h4><a href="'+mainurl+'" class="shopping-btn">'+ContinueShopping+'</a></div>');
                $('#grandttl').html('$0.00');
                $('#carttotal').html('$0.00');
            }
            ...
            $.each(response, function(i, cart){
                $.each(cart, function (index, data) {
                    ...
                    $("#goCart").append('<div class="cart-entry"> <div class="content"> <a class="title" href="'+url+'">'+data.title+'</a> <div class="quantity">'+Quantitylang+': '+data.quantity+'</div>'+str+''+str1+'<div class="price">'+Pricelang+':' +currency+data.cost+'</div></div><div class="button-x"><i class="fa fa-close" onclick=" getDelete('+data.product+')"></i></div></div>');
