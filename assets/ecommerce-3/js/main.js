$(document).ready(function() {
  ...
  $('.pagination li:first-child span').html('<i class="fas fa-long-arrow-alt-left"></i> Previous');
  $('.pagination li:first-child a').html('<i class="fas fa-long-arrow-alt-left"></i> Previous');
  $('.pagination li:last-child span').html('Next <i class="fas fa-long-arrow-alt-right"></i>');
  $('.pagination li:last-child a').html('Next <i class="fas fa-long-arrow-alt-right"></i>');
    ...
    $.each(response, function(i, cart){
      ...
      $.each(cart, function (index, data) {
        ...
        if(ship_info == 'Per Product')
        {
          ...
          {
            str = '<div class="quantity shipping_cost">'+language.shipping_cost+': '+data.shipping_cost+'</div>' ;
          } 
        ...
        if(tax_info == 'Per Product')
        {
          ...
          if(data.tax != 0)
          {
            ...
            str1 = '<div class="quantity tax">'+language.tax+'('+data.tax+'%): '+totaltax.toFixed(1)+'</div>' ;
          }
          else
          {
              str1 = '';
...
function getDelete(id) {
  $.get(mainurl+'/cartdelete/'+id, function(response){
    ...
    var str = '';
    var str1 = '';
    var rowCount = $('.product_cart tbody tr').length;
    ...
    if(rowCount == 0)
    {
      ...
      $('#emptycart').html(language.empty_cart);
      $('#wishlist').html('<div class="container"><div class="row"><h5>'+language.empty_cart+'</h5><div class="add-cart shopping-btn f-12"><a href="'+mainurl+'" class="text-white">'+language.continue_shopping+'</a></div></div></div>');
