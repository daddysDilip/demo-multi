                    ...
                    <div class="col-xs-12 col-sm-9 col-md-8 col-lg-5 center-block">
                        <div class="prtm-form-block prtm-full-block overflow-wrappper">
                            ...
                            <div class="prtm-block-content">
                                <form role="form" class="login-form" method="POST" action="<?php echo e(url('admin/login')); ?>" id="admin_login">
                                    ...
                                    <div class="login-meta mrgn-b-lg">
                                        <div class="row">
                                            <div class="col-xs-6 col-sm-6 col-md-6 text-left"> <a href="<?php echo url('/admin/forgotpassword'); ?>" class="text-primary password-style">Forgot Password?</a> </div>
...
</html><?php /**PATH D:\wamp\www\on_git\multi-ecomm\project\resources\views/admin/login.blade.php ENDPATH**/ ?>