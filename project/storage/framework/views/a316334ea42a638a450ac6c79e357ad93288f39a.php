...
<script>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(url('/')); ?>/assets/superadmin/favicon.png" />
    <meta name="robots" content="noindex" />
    <title>estoreWhiz</title>

    <link href="<?php echo e(URL::asset('assets/superadmin/css/bootstrap.min.css')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(URL::asset('assets/superadmin/css/mdb.min.css')); ?>" rel="stylesheet" type="text/css">
	
    <link href="<?php echo e(URL::asset('assets/superadmin/css/style.css')); ?>" rel="stylesheet" type="text/css">
	
    <link href="<?php echo e(URL::asset('assets/superadmin/css/responsive.css')); ?>" rel="stylesheet" type="text/css">
        ...
        <div class="nav-wrap">
          <div class="container">
            <nav class="navbar navbar-expand-lg bgcolor-white">
              <a class="navbar-brand" href="<?php echo e(url('/')); ?>"><img src="<?php echo e(url('/')); ?>/assets/superadmin/images/logo.png" class="img-responsive" alt="Logo"></a>
              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                  <li class="nav-item active">
                    <a class="nav-link f-14" href="<?php echo e(url('/')); ?>">Home <span class="sr-only">(current)</span></a>
                  </li>
                  <?php foreach($cmsmenu as $allcms) { 
                    if($allcms->menudisplay == 'header' || $allcms->menudisplay == 'both') {
                  ?>
                  <li class="nav-item">
                    <a class="nav-link f-14" href="/<?php echo e($allcms->slug); ?>"><?php echo e($allcms->name); ?></a>
                  </li>
                  <?php } } ?>
                  <li class="nav-item">
                 ...
                 <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
                  <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                      <img class="mx-auto d-block img-fluid" src="<?php echo e(url('/')); ?>/assets/images/sliders/<?php echo e($sliders[$i]->image); ?>" alt="<?php echo e($sliders[$i]->title); ?>">
                    </div>
					          <?php else: ?>
    ...
    <footer>
      <div class="container">
        <div class="row">
          <div class="col-lg-4">
            <div class="sm-desc">
              <img src="<?php echo e(url('/')); ?>/assets/superadmin/images/logo.png" class="d-block img-fluid">
            ...
            <div class="row">
              <div class="col-sm-6 col-md-auto">
                ...
                <ul class="f-14">
                  ...
                  ?>
                  <li><a href="/<?php echo e($allcms->slug); ?>"><?php echo e($allcms->name); ?></a></li>
                  <?php } } ?>
                </ul>
              </div>
              <div class="col-sm-6 col-md-auto">
...
<script>
    ...
    var ship_info = '<?php echo e($settings[0]->shipping_information); ?>';
    var tax_info = '<?php echo e($settings[0]->tax_information); ?>';
    var potax = '<?php echo e($settings[0]->tax); ?>';
    var poshipcost = '<?php echo e($settings[0]->shipping_cost); ?>';
...
<!--<script src="<?php echo e(URL::asset('assets/theme2/js/cart.js')); ?>" type="text/javascript"></script>-->
<script src="<?php echo e(URL::asset('assets/superadmin/js/popper.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(URL::asset('assets/superadmin/js/mdb.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(URL::asset('assets/superadmin/js/jquery.steps.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(URL::asset('assets/superadmin/js/custom.js')); ?>" type="text/javascript"></script>
...
</html><?php /**PATH D:\wamp\www\on_git\multi-ecomm\project\resources\views/sadmin/frontend/includes/home-header.blade.php ENDPATH**/ ?>