...
class MenusController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.menulist',compact('allmenus'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $allmenu->save();
        return redirect('admin/menus')->with('message','New Menu Added Successfully.');
    }
    ...
    public function edit($subdomain,$id)
    {
        ...
        return view('admin.menuedit',compact('allmenu'));
    }
    ...
    public function status($subdomain,$id , $status)
    {
        ...
        return redirect('admin/menus')->with('message','Menu Status Updated Successfully.');
    }
