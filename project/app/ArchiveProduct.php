...
{
        public $table = "archive_products";

    protected $fillable = ['productid','title', 'skucode', 'category', 'tags', 'description','sizes', 'price', 'offer_price', 'selling_price', 'stock', 'tax', 'shipping_cost', 'feature_image', 'policy', 'featured', 'views', 'created_at', 'updated_at', 'status','metatitle','metadec','metakey'];
