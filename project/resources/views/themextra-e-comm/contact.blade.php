                    ...
                    <div class="contact_box">
                        <div class="row">
                            <div class="col-md-4 col-sm-4">
                                <div class="icon_cir"><i class="fas fa-map-marker-alt"></i></div>
                                <p>{{$companydetails[0]->addressline1}}</p>
                                <p>{{$companydetails[0]->addressline2}}</p>
                            </div>
                            <div class="col-md-4 col-sm-4">
                                <div class="icon_cir"><i class="fas fa-phone"></i></div>
                                <p>{{$companydetails[0]->company_phone}}</p>
                            </div>
                            <div class="col-md-4 col-sm-4">
                                <div class="icon_cir"><i class="far fa-envelope-open"></i></div>
                                <p>{{$companydetails[0]->company_email}}</p>
                            </div>
                        </div>
                    </div>
                    <div class="comments-area">
                        <h3 class="text-center f-weight600">{{$language->contact_us_today}}</h3>
