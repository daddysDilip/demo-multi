                            ...
                            <div class="carousel-inner" >
                                ...
                                <div class="item <?php echo ($i == 0) ? 'active' : ''; ?>">
                                    <div class="voucher_bgimg">
                                        <div class="col-md-12 show_detail">
                ...
                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" role="tab" id="headingOne">
                            <h3 class="panel-title collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne" <?php if($login == 1) { ?>style="pointer-events: none;"<?php } ?>>
                            <a>1 {{trans('app.SignIn')}}</a>
                        </div>
                        <div id="collapseOne" class="panel-collapse collapse <?php if($login == 0) { ?>in<?php } ?>" role="tabpanel" aria-labelledby="headingOne">
                            <div class="panel-body">
                                <h2>{{trans('app.NoAccount')}}? | <a href="{{ route('user.login.submit',$subdomain_name) }}">{{trans('app.CreateOneHere')}}</a></h2>
                                <div class="row">
                                    <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" role="tab" id="headingTwo">
                            <h3 class="panel-title collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo" <?php if($login == 0) { ?>style="pointer-events: none;"<?php } ?>>
                                <a>2 {{trans('app.Orders')}}</a>
                            </h3>
                        </div>
                        @if($login == 1)
                        <div id="collapseTwo" class="panel-collapse collapse <?php if($login == 1) { ?>in<?php } ?>" role="tabpanel" aria-labelledby="headingTwo">
                            <div class="panel-body">
                                <table class="table-cart table checkout_table">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="cart_item">
                                          ...
                                          <td data-title="Quantity"><span>{{$cart->quantity}}</span></td>
                                          <td data-title="Price">
                                          ...
                                          <td class="product-subtotal" data-title="Total">
                                            <span class="amount">{{$settings[0]->currency_sign}}{{number_format($display_subtotal,2)}}</span>
                                          </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                ...
                                <p class="order_next pull-right" onclick="oderdetail()">{{trans('app.SaveAndContinue')}}</p>
                            </div>
                        </div>
                        @endif
                    </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading" role="tab" id="headingThree">
                            <h3 class="panel-title collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="true" aria-controls="collapseTwo"<?php if($login == 0) { ?>style="pointer-events: none;"<?php } ?>>
                                <a>3 {{trans('app.AddressesAndPayment')}}</a>
                            </h3>
                        </div>
                        @if($login == 1)
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="billing-details-area">
                                            <h4 class="text-uppercase f-20 clr-primary f-weight600">{{trans('app.BillingDeatils')}}</h4>
                                            <hr/>
...
$(document).ready(function(){
    ...
    $('#headingThree h3').css('pointer-events','none');
...
$("#collapseTwo .order_next").click(function() {
    $('#headingThree h3').css('pointer-events','visible');
                        ...
                        else
                        {
                            ...
                            else
                            {
                               // alert('001');
                                ...
                                var ptotaltax = finalstotal*(producttax/100);
                                var dtotal = Number(finalstotal) + Number(ptotaltax) ;
                               // alert(subtotal+'-'+shippingcost+'-'+mult);
