...
<main>
    <section class="inner-page-banner bgclr-primary pd-30">
        <div class="container">
            <div class="page-name f-24 text-uppercase f-weight600 clr-white text-center">{{trans('app.Order')}}# {{$order->order_number}} </div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active text-capitalize" aria-current="page">Order# {{$order->order_number}} </li>
                </ol>
            </nav>
        </div>
    </section>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered veiw-details-table">
                                    ...
                                    <tr style="font-weight: 600;">
                                        <td colspan="3" class="product_total">{{trans('app.SubTotal')}}</td>
                                    ...
                                    <tr style="font-weight: 600;">
                                        <td colspan="3" class="product_total">{{trans('app.Discount')}}<br>({{$order->discount_code}})</td>
                                    ...
                                    @if($settings[0]->shipping_information  == 'Per Order')
                                        ...
                                        <tr style="font-weight: 600;">
                                            <td colspan="3" class="product_total">{{trans('app.ShippingCost')}}</td>
                                    ...
                                    @if($settings[0]->tax_information  == 'Per Order')
                                        @if($order->tax != 0)
                                        <tr style="font-weight: 600;">
                                            <td colspan="3" class="product_total">{{trans('app.Tax')}}({{$order->tax}}%)</td>
                                            @if(!empty($order->discount_code))
                                                @php 
                                                    $tax = $order->tax;
                                    ...
                                    @endif
                                    <tr style="font-weight: 600;">
                                        <td colspan="3" class="product_total">{{trans('app.Total')}}</td>
