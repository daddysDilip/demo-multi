...
<main>
    <section class="inner-page-banner bgclr-primary pd-30">
        <div class="container">
            <div class="page-name f-24 text-uppercase f-weight600 clr-white text-center">{{trans('app.Mycart')}}</div>
            ...
            <div class="row wrapper">
                ...
                <div class="col-md-4">
                    <div class="cart-total">
                        ...
                        <div class="checkout add-cart f-12 text-uppercase"><a href="{{route('user.checkout',$subdomain_name)}}" class="text-white">{{trans('app.ProceedCheckout')}}</a></div>
                    </div>
                </div>
                @else
                <div class="col-md-12">
                    <h4 class="f-20">{{trans('app.EmptyCart')}}</h4>
                    <a href="{{url('/')}}" class="add-cart shopping-btn f-12 text-white">{{trans('app.ContinueShopping')}}</a>
                </div>
                @endif
            </div>
        </div>
