                ...
                <div class="col-md-9">
                    <div class="dashboard-content">
                        <div class="view-order-page">
                            <h3>{{trans('app.Order')}}# {{$order->order_number}} [{{$order->status}}]</h3>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        @if($order->shipping == "shipto")
                                            <h5>{{trans('app.ShippingAddress')}}</h5>
                                            ...
                                            @endif
                                        @else
                                            <h5>{{trans('app.PickUpLocation')}}</h5>
                                            <address>
                                    ...
                                    <div class="col-md-6">
                                        <h5>{{trans('app.ShippingMethod')}}</h5>
                                        @if($order->shipping == "shipto")
                            ...
                            <div class="billing-add-area">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h5>{{trans('app.BillingAddress')}}</h5>
                                        <address>
                                            {{$order->customer_firstname}} {{$order->customer_lastname}}<br>
                                            {{$order->customer_email}}<br>
                                            {{$order->customer_phone}}<br>
                                ...
                                <td>{{$allproduct->prodectname}}</td>
                                        <td align="right">
                                            ...
                                            @if($settings[0]->shipping_information  == 'Per Product' && $allproduct->shipping_cost != '')
                                                {{trans('app.ShippingCost')}}: {{$settings[0]->currency_sign}}{{number_format($allproduct->shipping_cost,2)}}
                                            @endif
