                            ...
                            <div class="row" id="products">
                                                    ...
                                                    <form class="addtocart-form">
                                                        ...
                                                        @if($product->stock != 0 || $product->stock === null )
                                                            @if((\App\Cart::where('product',$product->id)->where('uniqueid', Session::get('uniqueid'))->count()) > 0)
                                                                <a href="{{Url('cart')}}" type="button" class="addTo-cart"><i class="fa fa-cart-plus"></i><span>Go To Cart</span></a>
                                                            @else
                                ...
                                @empty
                                    <div class="row" style="margin-left: 0">
                                        <div class="col-md-12">
                                            <h3 style="margin-bottom: 0px;">{{$language->no_result}}</h3>
                                        </div>
                                    </div>
                                @endforelse
                            </div>
