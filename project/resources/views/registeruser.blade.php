                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-lg-offset-3 col-md-offset-3 col-md-6 col-sm-12 col-xs-12">
                        <div class="newAccount-area">
                            <h2 class="signIn-title">{{trans('app.CreateNewCustomerAccount')}}</h2>
                            <hr/>

                            <p>{{trans('app.CreateYourNewAccount')}}</p>
                            <form action="{{route('user.reg.submit',$subdomain_name)}}" method="post" id="form_customer">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12 text-right">
                                            <a href="{{url('user/login')}}">{{trans('app.AlreadyAccount')}}</a>
                                        </div>
                                    </div>
                                </div>
                                @if ($errors->has('name'))
                                ...
                                @endif
                                <div class="form-group">
                                    <input class="btn btn-md login-btn" type="submit" value="{{trans('app.SignUp')}}">
                                </div>
                            </form>
                        </div>
                    </div>
