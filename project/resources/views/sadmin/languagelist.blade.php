    ...
    <div class="prtm-content-wrapper">
        <div class="prtm-content">
            <div class="prtm-page-bar">
                <ul class="breadcrumb">
                    <li class="breadcrumb-item text-cepitalize"><h3>Language</h3> </li>
                                    ...
                                    <tr>
                                        <td>
                                              @if($langu->image != '')
                                                  ...
                                                  <img src="{{url('/assets/images/language')}}/{{$langu->image}}" alt="" class="service-icon" width="120px" height="70px">
                                            @else
                                        ...
                                        <td>    
                                             @if($langu->status == 1)
                                                <a href="{!! url('sadmin/language') !!}/status/{{$langu->id}}/0" class="btn btn-success btn-xs">Active</a>
                                            @elseif($langu->status == 0)
                                                <a href="{!! url('sadmin/language') !!}/status/{{$langu->id}}/1" class="btn btn-danger btn-xs">Deactive</a>
                                             @endif
                                        ...
                                        <td>
                                            <div class="dropdown display-ib">
                                                ...
                                                <ul class="dropdown-menu dropdown-arrow dropdown-menu-right">
                                                    <li>
                                                        <a href="language/{{$langu->id}}/edit"><i class="fa fa-edit"></i> <span class="mrgn-l-sm">Edit </span> </a>
                                                    </li>
                                                    <li>
                                                        <a href="#" onclick="return delete_data('{{$langu->id}}');"><i class="fa fa-trash"></i> <span class="mrgn-l-sm">Delete </span></a>
                                                    </li>
                                                </ul>  
                                            </div>
                                        </td>
