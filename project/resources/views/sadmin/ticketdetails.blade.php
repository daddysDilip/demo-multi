                        ...
                        <div class="typography-widget col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            <div class="prtm-block">
                                <div class="prtm-block-title">
                                    <h3>
                                        @if($companysetting[0]->logo != '')
                                            <img src="{!! url('assets/images/company') !!}/{{$companysetting[0]->logo}}" class="square-50 display-ib img-circle" alt="User Image">{{$company[0]->comapany_name}}
                                        @else
                                                ...
                                                <div class="col-sm-12 col-md-9">
                                                    ...
                                                    <div class="row mrgn-b-md">
                                                        ...
                                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                                            <div class="dropdown display-ib" style="    left: -10px;">
                                                                <a href="javascript:;" class="mrgn-l-xs" data-toggle="dropdown" data-hover="dropdown" data-close-others="true" aria-expanded="false"> <span class="label label-<?php echo $status; ?> btn-rounded font-sm">{{ \App\TicketStatus::find($ticket->ticketstatus)->name }}</span></a>
                                                                <ul class="dropdown-menu dropdown-arrow dropdown-menu-right">
                                                                @foreach($allstatus as $tstatus)
                                                                    <li>
                                                                        <a href="#" onclick="return change_status('<?php echo $tstatus->id; ?>','<?php echo $ticket->tempcode; ?>');"><span class="mrgn-l-sm"><i class="fa fa-right-arrow" aria-hidden="true"></i>{{$tstatus->name}}</span> </a>
                                                                    </li>
                                                                @endforeach
                                                                </ul>
                                                            </div>
                        ...
                        <div class="prtm-block">
                            <div class="horizontal-form-style">
                                ...
                                <div class="chat-window pad-l-lg  clearfix">
                                                    ...
                                                    @if($userid == $reply->userid) 
                                                        <div class="sent-msg mrgn-b-lg">
                                                            <div class="clearfix">
                                                                ...
                                                                <div class="thumb-wid mrgn-l-sm pull-right"> <img class="img-responsive img-circle" src="{!! url('assets/images/company') !!}/{{$settings[0]->logo}}" alt="message reciever image" style="height: 80px;width: 150px;"> </div>
                                                                ...
                                                                <div class="thumb-content">
                                                                    ...
                                                                    <div class="clearfix"> 
                                                                        <span class="pull-left base-dark display-ib">
                                                                            {{\App\User::find($reply->userid)->name}}</span> <span class="pull-right display-ib"><?php echo date("jS, M Y H:i:sA",strtotime($reply->timestamp)); ?></span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="mrgn-b-lg">
                                                            <div class="clearfix">
                                                                <div class="thumb-wid mrgn-r-sm pull-left"> 
                                                                    @if($companysetting[0]->logo != '')
                                                                    <img class="img-responsive img-circle" src="{!! url('assets/images/company') !!}/{{$companysetting[0]->logo}}" alt="message reciever image" style="height: 80px;width: 150px;">
                                                                    @else
                                                                ...
                                                                <div class="thumb-content pull-right">
                                    ...
                                    <form action="{{action('Sadmin\TicketController@addreply')}}" method="post" enctype="multipart/form-data" name="form1" id="reply_ticket">
                                        {{csrf_field()}}
                                        ...
                                        <div class="send-msg-form col-sm-12 col-xs-12 col-md-12 col-lg-12 pull-right pad-all-none">
                                            ...
                                            <div class="form-group clearfix">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                                                    <input class="btn btn-danger btn-lg btn-block pad-all-sm" value="Cancel" type="button" id="reset"> 
                                                </div>
                                            </div>
...
<script type="text/javascript">
    ...
    function change_status(id,tempcode)
    { 
        window.location = "{{url('/')}}/sadmin/tickets/changestatus/"+id+"/"+tempcode;
        return true;
    }
