                    ...
                    <div class="col-xs-12 col-sm-9 col-md-8 col-lg-5 center-block">
                        <div class="prtm-form-block prtm-full-block overflow-wrappper">
                            ...
                            <div class="prtm-block-content">
                                <form role="form" class="login-form" method="POST" action="{{ url('sadmin/login') }}" id="admin_login">
                                    {{ csrf_field() }}
                                    @if ($errors->has('email'))
                                    ...
                                    <!-- <div class="login-meta mrgn-b-lg">
                                        <div class="row">
                                            <div class="col-xs-6 col-sm-6 col-md-6">
                                                <div class="checkbox">
                                                     <label>
                                                        <input type="checkbox" name="remember_me" {{ old('remember') ? 'checked' : '' }}><span class="text-capitalize">Remember me</span>
                                                    </label>  
                                                </div>
                                            </div>
                                            <div class="col-xs-6 col-sm-6 col-md-6 text-right"> <a href="{!!url('/sadmin/forgotpassword') !!}" class="text-primary password-style">Forgot Password?</a> </div> 
                                        </div>
                                    </div> -->
                                    <!-- <div class="login-meta mrgn-b-lg">
                                        <div class="row">
                                    ...
                                    <!-- <div class="text-center"> <a class="back-home-btn" href="{!! url('/') !!}"><i class="fa fa-long-arrow-left mrgn-r-xs"></i>Back To Home</a> </div> -->
                                </form>
                            </div>
                        </div>
                    </div>
