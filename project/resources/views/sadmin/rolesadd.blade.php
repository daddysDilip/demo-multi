        ...
        <div class="prtm-content">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div id="response"></div>
                    <form method="POST" action="{!! action('Sadmin\RolesController@store') !!}" class="form-horizontal form-label-left" enctype="multipart/form-data" id="role_form">
                        {{csrf_field()}}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="role" class="form-control col-md-7 col-xs-12" name="role" placeholder="Enter Role Name" type="text" maxlength="30" minlength="3">
                            </div>
                        </div>
						...
						<div class="form-group">
						  ...
						  <div class="col-md-6 col-sm-6 col-xs-12" style="padding:0px;">
						     @foreach($allmenu as $menu)
							 	...
							 	<div class="col-sm-6">
									<input type="checkbox" id="{{$menu->id}}" name="menuid[]" value="{{$menu->id}}"  data-on-text="<i class='fa fa-check'></i>" data-off-text="<i class='fa fa-times'></i>">&nbsp;&nbsp;&nbsp;{{$menu->name}}<br><br>
							     </div>
							  @endforeach
