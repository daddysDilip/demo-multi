                    ...
                    <div class="col-xs-12 col-sm-9 col-md-8 col-lg-5 center-block">
                        <div class="prtm-form-block prtm-full-block overflow-wrappper">
                            ...
                            <div class="prtm-block-content">
                                <form action="{{ url('sadmin/forgotpassword') }}" class="login-form" method="POST" id="forgot_form">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="text-center"> <a class="back-home-btn" href="{!! url('/sadmin/login') !!}"><i class="fa fa-long-arrow-left mrgn-r-xs"></i>Back To Login</a> </div>
                                </form>
                            </div>
                        </div>
                    </div>
