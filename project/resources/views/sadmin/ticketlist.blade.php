                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#all" data-toggle="tab" aria-expanded="true">All &nbsp;<span class="badge badge-inverse">{{ \App\Ticket::count() }}</span></a>
                            </li>
                            <li><a href="#new" data-toggle="tab" aria-expanded="false">New &nbsp;<span class="badge badge-primary">{{ \App\Ticket::where('ticketstatus',1)->count() }}</span></a></li>
                            <li><a href="#open" data-toggle="tab" aria-expanded="false">Open &nbsp;<span class="badge badge-info">{{ \App\Ticket::where('ticketstatus',2)->count() }}</span></a></li>
                            <li><a href="#inprogress" data-toggle="tab" aria-expanded="false">In Progress &nbsp;<span class="badge badge-secondary">{{ \App\Ticket::where('ticketstatus',3)->count() }}</span></a></li>
                            <li><a href="#closed" data-toggle="tab" aria-expanded="false">Closed &nbsp;<span class="badge badge-success">{{ \App\Ticket::where('ticketstatus',4)->count() }}</span></a></li>
                            <li><a href="#rejected" data-toggle="tab" aria-expanded="false">Rejected &nbsp;<span class="badge badge-danger">{{ \App\Ticket::where('ticketstatus',5)->count() }}</span></a>
                            </li>
                        </ul>
                    </div>
