                    ...
                    <form method="POST" action="{!! action('Sadmin\CompanyController@store') !!}" class="form-horizontal form-label-left" enctype="multipart/form-data" id="general_form">
		                ...
		                <div class="row clearfix">
								...
								<div class="card">
				                    ...
				                    <div class="body">                                
										<div class="prtm-block min-height-505">
											...
											<div class="row clearfix">
                                            	<div class="col-lg-3 col-md-3 col-sm-4 form-control-label">
				                                    <label for="email_address_2">User Name<span class="required">*</span></label>
				                                </div>
				                                <div class="col-lg-9 col-md-9 col-sm-8">
				                                    <div class="form-group">
				                                        <input id="username" class="form-control " name="username" placeholder="Enter User Name" type="text" maxlength="30" minlength="3" style="text-transform: lowercase;">
				                                    </div>
				                                </div>
											...
											<div class="row clearfix">
                                            	<div class="col-lg-3 col-md-3 col-sm-4 form-control-label">
				                                    <label for="email_address_2">Email Adress<span class="required">*</span></label>
				                                </div>
				                                <div class="col-lg-9 col-md-9 col-sm-8">
				                                    <div class="form-group">
				                                        <input id="company_email" class="form-control " name="company_email" placeholder="Enter Email Address" type="email" maxlength="50" minlength="3">
				                                    </div>
				                                </div>
											...
											<div class="row clearfix">
                                            	<div class="col-lg-3 col-md-3 col-sm-4 form-control-label">
				                                    <label for="email_address_2">Phone Number<span class="required">*</span></label>
				                                </div>
				                                <div class="col-lg-9 col-md-9 col-sm-8">
				                                    <div class="form-group">
				                                        <input id="company_phone" class="form-control " name="company_phone" placeholder="Enter Phone Number" type="text" maxlength="15" minlength="10" onkeypress="return isNumber(event)" >
				                                    </div>
				                                </div>
											...
											<div class="row clearfix">
                                            	<div class="col-lg-3 col-md-3 col-sm-4 form-control-label">
				                                    <label for="email_address_2">Select Plan<span class="required">*</span></label>
				                                </div>
				                                <div class="col-lg-9 col-md-9 col-sm-8">
				                                    <select class="form-control show-tick" name="planid" id="planid" required>
											...
											<div class="row clearfix">
                                            	<div class="col-lg-3 col-md-3 col-sm-4 form-control-label">
				                                    <label for="email_address_2">Select Language<span class="required">*</span></label>
				                                </div>
				                                <div class="col-lg-9 col-md-9 col-sm-8">
				                                    <select class="form-control show-tick" multiple name="language[]" id="language" required >
											...
											<div class="row clearfix">
                                            	<div class="col-lg-3 col-md-3 col-sm-4 form-control-label">
				                                    <label for="email_address_2">Company Logo<span class="required">*</span></label>
				                                </div>
				                                <div class="col-lg-9 col-md-9 col-sm-8">
				            ...
				            <div class="col-md-6 col-lg-6">
								<div class="card">
				                    <div class="header">
				                        <h2><strong>Address</strong> <small> Information</small> </h2>                        
				                    </div>
				                    <div class="body">                                
										<div class="prtm-block min-height-505">
											<div class="horizontal-form-style">
                                            	...
                                            	<div class="row clearfix">
	                                            	<div class="col-lg-3 col-md-3 col-sm-4 form-control-label">
					                                    <label for="email_address_2">Address Line 1<span class="required">*</span></label>
					                                </div>
					                                <div class="col-lg-9 col-md-9 col-sm-8">
					                                    <div class="form-group">
					                                        <input id="addressline1" class="form-control " name="addressline1" placeholder="Enter Address Line 1" type="text" maxlength="100" minlength="3" >
					                                    </div>
					                                </div>
												...
												<div class="row clearfix">
	                                            	<div class="col-lg-3 col-md-3 col-sm-4 form-control-label">
					                                    <label for="email_address_2">Address Line 2<span class="required">*</span></label>
					                                </div>
					                                <div class="col-lg-9 col-md-9 col-sm-8">
					                                    <div class="form-group">
					                                        <input id="addressline2" class="form-control " name="addressline2" placeholder="Enter Address Line 2" type="text" maxlength="100" minlength="3" >
					                                    </div>
					                                </div>
												...
												<div class="row clearfix">
	                                            	<div class="col-lg-3 col-md-3 col-sm-4 form-control-label">
					                                    <label for="email_address_2">Select State<span class="required">*</span></label>
					                                </div>
					                                <div class="col-lg-9 col-md-9 col-sm-8">
														...
														<select class="form-control show-tick " data-live-search="true" name="state" id="state" required>
												...
												<div class="row clearfix">
	                                            	<div class="col-lg-3 col-md-3 col-sm-4 form-control-label">
					                                    <label for="email_address_2">Select City<span class="required">*</span></label>
					                                </div>
					                                <div class="col-lg-9 col-md-9 col-sm-8">
														...
														<select class="form-control show-tick " data-live-search="true" name="city" id="city" required>
												...
												<div class="row clearfix">
	                                            	<div class="col-lg-3 col-md-3 col-sm-4 form-control-label">
					                                    <label for="email_address_2">Pincode<span class="required">*</span></label>
					                                </div>
					                                <div class="col-lg-9 col-md-9 col-sm-8">
					                                    <div class="form-group">
