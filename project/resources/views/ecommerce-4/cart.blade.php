                    ...
                    <div class="col-md-4 col-sm-6" style="float: right;">
                        <div class="cart_total_box">
                            ...
                            <div class="table-responsive">
                                ...
                                <a href="{{route('user.checkout',$subdomain_name)}}" class="checkout btn text-white">{{trans('app.ProceedCheckout')}}</a>
                            </div>
                        </div>
                    </div>
                </div>
