          ...
          <div class="prod-sidebar">
            <div class="category">
                            ...
                            <div id="collapse{{$i}}{{$j}}" class="panel-collapse collapse">
                              <div class="panel-body">
                                <ul>
                                  ...
                                  <li>
                                    <i class="fa fa-angle-right"></i><a href="{{url('/category')}}/{{$childmenu->slug}}"> {{$childmenu->name}}</a>
                                  </li>
                                  @endforeach
                                </ul>
                              </div>
              ...
              <div class="filter-wrap filter-tag">
                <h3 class="filter">{{$language->popular_tags}}</h3>
                <ul>
        ...
        <div class="col-md-9 col-sm-8">
          <div class="main-grid-wrap">
            ...
            <div class="product-grid-wrap">
              <span class="prod-cat-name">{{$category->name}}</span>
              <span class="result">
              ...
              <div class="tab-content">
                            ...
                            <div class="addcart_sec_{{$product->id}}">
                              @if($product->stock != 0 || $product->stock === null )
                                @if((\App\Cart::where('product',$product->id)->where('uniqueid', Session::get('uniqueid'))->count()) > 0)
                                  <a href="{{Url('cart')}}" class="p-btn buy-now">Go To Cart</a>
                                @else
                                  <a href="javascript:;" class="to-cart p-btn buy-now"><img src="{{url('/assets/images')}}/default.gif" id="loadr_img" class="to_cart_loader">{{$language->add_to_cart}}</a>
                                @endif
                              @else
                                <a href="javascript:;" class="out_stock_btn p-btn buy-now">{{$language->out_of_stock}}</a>
                              @endif
                            </div>
                          </form>
                        </div>
                ...
                @else
                  <h4 class="text-center" style="margin-top: 50px;">No Products Found</h4>
                @endif
              </div>
            </div>
          </div>
