            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="prtm-block-title mrgn-b-lg">
                        <div class="caption">
                            <a href="{!! url('admin/menus/create') !!}" class="btn btn-primary btn-add"><i class="fa fa-plus"></i> Add New Menu</a>
                        </div>
                    </div>
                     <table class="table table-striped table-bordered" cellspacing="0" id="example" width="100%">
                        ...
                        @foreach($allmenus as $allmenu)
                            <tr>
                                ...
                                <td>
                                    @if($allmenu->status == 1)
                                        <a href="{!! url('admin/menus') !!}/status/{{$allmenu->id}}/0" class="btn btn-success btn-xs">Active</a>
                                    @elseif($allmenu->status == 0)
                                        <a href="{!! url('admin/menus') !!}/status/{{$allmenu->id}}/1" class="btn btn-danger btn-xs">Deactive</a>
                                    @endif
                                </td>
                                <td>
...
<script type="text/javascript">
    ...
    function delete_data(reportid)
    {
        ...
        {
            window.location = "{{url('/')}}/admin/menus/delete/"+reportid;
            return true;
        }
        else
        {
