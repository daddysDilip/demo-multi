        ...
        <div class="prtm-content">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div id="response"></div>
                    <div class="col-xs-12">
                        <form method="POST" action="{!! action('ChildCategoryController@store',$subdomain_name) !!}" class="form-horizontal form-label-left" enctype="multipart/form-data" id="category_form">
                            {{csrf_field()}}
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="default_lang">
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">{{trans('app.SubCategory')}}<span class="required">*</span></label>

                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control" name="subid" id="subs" disabled required>
                                                <option value="">{{trans('app.SelectSubCategory')}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="item form-group">
