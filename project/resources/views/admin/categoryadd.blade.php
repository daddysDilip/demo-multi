        ...
        <div class="prtm-content">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="col-xs-12">
                        <form method="POST" action="{!! action('CategoryController@store',$subdomain_name) !!}" class="form-horizontal form-label-left" enctype="multipart/form-data" id="category_form">
                            {{csrf_field()}}
                            <div class="tab-content">
                                <div class="tab-pane active" id="default_lang">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="slug" class="form-control col-md-7 col-xs-12" name="slug" type="text" style="text-transform: lowercase;" maxlength="30" minlength="3">
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                    ...
                                    <div class="item form-group" id="fimg" style="display: none;">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <input type="file" accept="image/*" name="fimage" id="file" onchange="readURL(this);" required />
                                        </div>
                                    </div>
