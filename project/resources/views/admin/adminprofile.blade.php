        ...
        <div class="prtm-content">
            <div class="prtm-page-bar">
                <ul class="breadcrumb">
                    <li class="breadcrumb-item text-cepitalize">
                        <h3>{{ trans('app.AdminProfile') }}</h3> </li>
                    <li class="breadcrumb-item"><a href="{!! url('admin/dashboard') !!}">{{ trans('app.Home') }}</a></li>
                    <li class="breadcrumb-item">{{ trans('app.AdminProfile') }}</li>
                </ul>
            </div>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <form method="POST" action="{{url('admin/adminprofile')}}/{{$admin->id}}" class="form-horizontal form-label-left" enctype="multipart/form-data" id="admin_profile">
                        {{csrf_field()}}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input class="form-control col-md-7 col-xs-12" name="email" placeholder="Admin Email" value="{{$userdata[0]->username}}" type="text" maxlength="50" minlength="3" readonly>
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input class="form-control col-md-7 col-xs-12" name="email" placeholder="Admin Email" value="{{$userdata[0]->email}}" type="text" maxlength="50" minlength="3" readonly>
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input class="form-control col-md-7 col-xs-12" name="name" placeholder="Admin Name" value="{{$userdata[0]->name}}" type="text" maxlength="50" minlength="3">
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input class="form-control col-md-7 col-xs-12" name="phone" placeholder="Admin Phone Number" value="{{$userdata[0]->phone}}" type="text" maxlength="10" minlength="10">
                            </div>
                        </div>
