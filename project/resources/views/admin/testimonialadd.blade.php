        ...
        <div class="prtm-content">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="col-xs-12">
                        <form method="POST" action="{!! action('TestimonialController@store',$subdomain_name) !!}" class="form-horizontal form-label-left" id="testimonial_form">
                            {{csrf_field()}}
                                ...
                                <div class="tab-pane active" id="default_lang">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <textarea name="review" class="form-control" rows="6" maxlength="500" minlength="3"></textarea>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="name" class="form-control col-md-7 col-xs-12" name="client" type="text" maxlength="30" minlength="3">
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="slug" class="form-control col-md-7 col-xs-12" name="designation" type="text" maxlength="30" minlength="3">
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="tab-pane" id="{{$alllang}}">
                                           ...
                                           <br><br>
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <textarea name="trans_review[]" class="form-control" rows="6" maxlength="500" minlength="3"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input id="slug" class="form-control col-md-7 col-xs-12" name="trans_designation[]" type="text" maxlength="30" minlength="3">
                                                </div>
                                            </div>
