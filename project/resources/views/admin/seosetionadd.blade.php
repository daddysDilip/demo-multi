        ...
        <div class="prtm-content">
            ...
            <div class="panel panel-default">
              ...
              <!--       <ul class="nav nav-tabs">
                    ...
                    <div id="response"></div>
                    <div class="col-xs-12">
                        <form method="POST" action="{!! action('PageSettingsController@seoinsert',$subdomain_name) !!}" class="form-horizontal form-label-left" enctype="multipart/form-data" id="event_form">
                            {{csrf_field()}}
