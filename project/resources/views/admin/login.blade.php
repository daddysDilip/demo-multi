                    ...
                    <div class="col-xs-12 col-sm-9 col-md-8 col-lg-5 center-block">
                        <div class="prtm-form-block prtm-full-block overflow-wrappper">
                            ...
                            <div class="prtm-block-content">
                                <form role="form" class="login-form" method="POST" action="{{ url('admin/login') }}" id="admin_login">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="login-meta mrgn-b-lg">
                                        <div class="row">
                                            <div class="col-xs-6 col-sm-6 col-md-6 text-left"> <a href="{!!url('/admin/forgotpassword') !!}" class="text-primary password-style">Forgot Password?</a> </div>
