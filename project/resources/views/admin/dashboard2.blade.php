...
<div class="block-header">
  <div class="row">
    <div class="col-lg-7 col-md-6 col-sm-12">
      <h2>Dashboard<small class="text-muted">Welcome to Dashboard</small></h2>
    </div>
        ...
        <ul class="row profile_state list-unstyled">
          <li class="col-lg-4 col-md-4 col-6">
            <div class="body" style="background: linear-gradient(45deg, #fda582, #f7cf68) !important;">
                ...
                <h4>{{ \App\Product::where('company_id',$companyid)->count() }}</h4>
                <span>{{ trans('app.TotalProducts') }}!</span>
            </div>
          </li>
          <li class="col-lg-4 col-md-4 col-6">
            <div class="body" style="    background: linear-gradient(45deg, #72c2ff, #86f0ff) !important;color: #fff !important;">
                ...
                <span>{{ trans('app.OrdersPending') }}!</span>
            </div>
          </li>
          <li class="col-lg-4 col-md-4 col-6" style="background: linear-gradient(45deg, #a890d3, #edbae7) !important;color: #fff !important;">
            <div class="body">
                <i class="fa fa-truck"></i>
                <h4>{{ \App\Order::where('payment_status','Completed')->where('status','pending')->where('company_id',$companyid)->count() }}</h4>
                <span>{{ trans('app.OrdersProcessing') }}!</span>
            </div>
          </li>
          <li class="col-lg-4 col-md-4 col-6">
            <div class="body" style="background: linear-gradient(45deg, #00ced1, #08e5e8) !important;color: #fff !important;">
                <i class="fa fa-check"></i>
                <h4>{{ \App\Order::where('payment_status','Completed')->where('status','processing')->where('company_id',$companyid)->count() }}</h4>
                <span>{{ trans('app.OrdersCompleted') }}!</span>
            </div>
          </li>
          <li class="col-lg-4 col-md-4 col-6">
            <div class="body" style="background: linear-gradient(45deg, #ec74a1, #fbc7c0) !important;color: #fff !important;">
                <i class="fa fa-user"></i>
                <h4>{{ \App\UserProfile::where('company_id',$companyid)->count() }}</h4>
                <span>{{ trans('app.TotalCustomers') }}!</span>
            </div>
          </li>  
          <li class="col-lg-4 col-md-4 col-6">
            <div class="body" style="background: linear-gradient(45deg, #9ce89d, #cdfa7e) !important;">
                <i class="fa fa-at"></i>
                <h4>{{ \App\Subscribers::where('company_id',$companyid)->count() }}</h4>
                <span>{{ trans('app.TotalSubscribers') }}!</span>
            </div>
          </li> 
        </ul>
      </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <div class="prtm-block custom_scrollbar" style="height: 610px;overflow-y: auto;">
                    ...
                    <div class="prtm-block-content">
                        <div class="prtm-to-do">
                            <ul class="list-unstyled border-list-xs">
                            @if(isset($ticket) && sizeof($ticket) > 0)
