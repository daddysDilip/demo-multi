            ...
            <div class="prtm-page-bar">
                <ul class="breadcrumb">
                    <li class="breadcrumb-item text-cepitalize">
                        <h3>{{ trans('app.MailServices') }}</h3> </li>
                    <li class="breadcrumb-item"><a href="{!! url('admin/dashboard') !!}">{{ trans('app.Home') }}</a></li>
                    <li class="breadcrumb-item">{{ trans('app.EmailCompose') }}</li>
                </ul>
            </div>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="col-lg-6 col-md-6 col-sm-6 mail-content">
                        ...
                        <form method="POST" action="{!! action('EmailcomposeController@store',$subdomain_name) !!}" class="form-horizontal form-label-left" enctype="multipart/form-data" id="email_form">
                            {{csrf_field()}}
                            ...
                            <div class="compose-header">
                                <div class="compose-field">
                                    <div class="compose-field-right">
                                        <div class="btn-group">
                                            <button class="btn btn-link link-muted collapsed cc_email" title="Show Cc" data-target="#cc" data-toggle="collapse" type="button" aria-expanded="false"> <small>{{ trans('app.Cc') }}</small> </button>
                                            <button class="btn btn-link link-muted collapsed bcc_email" title="Show Bcc" data-target="#bcc" data-toggle="collapse" type="button" aria-expanded="false"> <small>{{ trans('app.Bcc') }}</small> </button>
                                        </div>
                                    </div>
                                ...
                                <div class="compose-fields mrgn-b-xs">
                                    <div class="collapse" id="cc" aria-expanded="false" style="height: 0px;">
                                        <div class="compose-field">
                                            <div class="compose-field-left">
                                                <button class="compose-label" type="button">{{ trans('app.Cc') }}</button>
                                            </div>
                                            <div class="compose-field-body">
                                    ...
                                    <div class="collapse" id="bcc" aria-expanded="false" style="height: 0px;">
                                        <div class="compose-field">
                                            <div class="compose-field-left">
                                                <button class="compose-label" type="button">{{ trans('app.Bcc') }}</button>
                                            </div>
                                            <div class="compose-field-body">
                                ...
                                <div class="compose-body">
                                    ...
                                    <div class="compose-actions">
                                        ...
                                        <button class="btn btn-inverse btn-lg discard_btn" type="reset"><i class="fa fa-times" aria-hidden="true"></i> &nbsp;{{ trans('app.Discard') }}</button>
                                    </div>
                                </div>
