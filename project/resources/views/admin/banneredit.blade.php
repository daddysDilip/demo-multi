        ...
        <div class="prtm-content">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div id="response"></div>
                    <form method="POST" action="{{url('admin/banner')}}/{{$banner->id}}/update" class="form-horizontal form-label-left" enctype="multipart/form-data" id="banner_form">
                        {{csrf_field()}}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="name" class="form-control col-md-7 col-xs-12" name="link" value="{{$banner->link}}" placeholder="Enter Blog Title" type="text">
                            </div>
                        </div>
                        <div class="item form-group">
