    ...
    <section class="sign-inwrap">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-box">
                        <h2>{{trans('app.CreateanAccount')}}</h2>
                        <form action="{{route('user.reg.submit',$subdomain_name)}}" method="POST" id="form_customer">
                            ...
                            <div class="form-row">
                                ...
                                <button type="submit" class="btn btn-default">{{trans('app.CreateanAccount')}}</button>
                            </div>
                        </form>
                        <p class="hr-login"><span>{{trans('app.Or')}}</span></p>
                        <a class="btn btn-default green" href="{{url('user/login')}}">{{trans('app.SignIn')}}</a>
                    </div>
                </div>
            </div>
        </div>
