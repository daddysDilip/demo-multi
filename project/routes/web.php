...
Route::group(['domain' => 'demo-multi.com'], function()
{
    ...
    Route::post('/store/get_plan', 'Sadmin\FrontEndController@get_plan');
	    Route::post('/store/temp_register', 'Sadmin\FrontEndController@temp_add_store');
    ...
    Route::post('/sadmin/allpostscompany', 'Sadmin\CompanyController@allPosts' )->name('allpostscompany');
    Route::get('/sadmin/companypdf/{id}', 'Sadmin\CompanyController@companypdf');
    ...
    Route::post('/sadmin/allpostrole', 'Sadmin\RolesController@allPosts' )->name('allpostrole');
    ...
    Route::post('/sadmin/allpostuser', 'Sadmin\UserController@allPosts' )->name('allpostuser');
    ...
    Route::post('/sadmin/allpostscms', 'Sadmin\CmsController@allPosts' )->name('allpostscms');
    ...
    Route::post('/sadmin/allpostsslider', 'Sadmin\SliderController@allPosts' )->name('allpostsslider');
    ...
    Route::post('/sadmin/allpostcountry', 'Sadmin\CountryController@allPosts' )->name('allpostcountry');
    ...
    Route::post('/sadmin/allpostpayment', 'Sadmin\PaymentMethodController@allPosts' )->name('allpostpayment');
    ...
    Route::post('/sadmin/allpostsshipping', 'Sadmin\ShippingMethodController@allPosts' )->name('allpostsshipping');
    ...
    Route::get('/sadmin/exportthemebuyer', 'Sadmin\BuyThemeController@Exportdata');
      Route::post('/sadmin/allpoststhemebuyer', 'Sadmin\BuyThemeController@allPosts' )->name('allpoststhemebuyer');
    ...
    Route::get('/sadmin/contactus/status/{id}/{status}','Sadmin\ContactusController@status');
     Route::post('/sadmin/allpostscontact', 'Sadmin\ContactusController@allPosts' )->name('allpostscontact');
    ...
    Route::post('/sadmin/allpostslanguage', 'Sadmin\LanguageController@allPosts' )->name('allpostslanguage');
    ...
    Route::post('/sadmin/allpostsblog', 'Sadmin\BlogController@allPosts' )->name('allpostsblog');
...
{    
  ...
  //  Route::post('user/update/{id}', 'UserProfileController@update')->name('user.update');
    ...
    Route::post('/admin/importslider','SliderController@import')->name('importslider');
      Route::post('/admin/allpostsadminslider','SliderController@allPosts' )->name('allpostsadminslider');
    ...
    Route::get('/admin/customers/delete/{id}','CustomerController@destroy');
     Route::post('/admin/allpostsadmincustomers','CustomerController@allPosts' )->name('allpostsadmincustomers');
    ...
    Route::post('/admin/allpostsadminblog','BlogController@allPosts' )->name('allpostsadminblog');
    ...
    Route::post('/admin/importnews','NewsController@import')->name('importnews');
     Route::post('/admin/allpostsadminnews','NewsController@allPosts' )->name('allpostsadminnews');
    ...
    Route::get('/admin/event/delete/{id}','EventController@destroy');
     Route::post('/admin/allpostsadminevent','EventController@allPosts' )->name('allpostsadminevent');
    ...
    Route::post('/admin/allpostsadmincms','CmsController@allPosts' )->name('allpostsadmincms');
    ...
    Route::get('/admin/delete/userprofile/{id}','UserController@deleteimage');
     Route::post('/admin/allpostsadminuser','UserController@allPosts' )->name('allpostsadminuser');
    ...
    Route::post('/admin/existrole','RolesController@exist_role');
     Route::post('/admin/allpostsadminrole','RolesController@allPosts' )->name('allpostsadminrole');
    ...
    Route::post('/admin/allpostsadminemail','EmailtemplatesController@allPosts' )->name('allpostsadminemail');
  ...
  Route::post('/admin/allpostsadmincontactus','ContactusController@allPosts' )->name('allpostsadmincontactus');

    Route::resource('/admin/review', 'ReviewController');
    Route::get('/admin/review/status/{id}/{status}','ReviewController@status');

 Route::post('/admin/allpostsadminreview','ReviewController@allPosts' )->name('allpostsadminreview');
    ...
    Route::post('/admin/exist_discode','DiscountController@exist_discode');
     Route::post('/admin/allpostsadmindiscount','DiscountController@allPosts' )->name('allpostsadmindiscount');
    ...
    Route::post('/admin/allpostsadmtestimonial','TestimonialController@allPosts' )->name('allpostsadmtestimonial');
    ...
    Route::post('/admin/allpostsmain','CategoryController@allpostsmain')->name('allpostsmain');




    Route::get('/subcats/{id}', 'SubCategoryController@subcats')->name('subcats');
    Route::get('/subget/{id}', 'SubCategoryController@subget')->name('subget');
    ...
    Route::post('/admin/allpostsfaq','PageSettingsController@allPosts' )->name('allpostsfaq');
    Route::post('/admin/allpostsbanner','PageSettingsController@allPostsbanner' )->name('allpostsbanner');
    Route::post('/admin/allpostsbrandlogo','PageSettingsController@allPostsbrandlogo' )->name('allpostsbrandlogo');
    Route::post('/admin/allpostsseo','PageSettingsController@allpostsseo' )->name('allpostsseo');
    Route::get('/admin/seoadd','PageSettingsController@seoadd' )->name('seoadd');
    Route::post('/admin/seoinsert','PageSettingsController@seoinsert' )->name('seoinsert');
    Route::get('/admin/seoview/{id}','PageSettingsController@seoview' )->name('seoview');
    Route::patch('/admin/seosetionupdate','PageSettingsController@seosetionupdate');
    ...
    Route::post('/admin/importprodect','ProductController@import')->name('importprodect');
    Route::post('/admin/allpostsproduct', 'ProductController@allPosts' )->name('allpostsproduct');
    ...
    Route::post('/admin/allpostsadminsubscribers','SubscriberController@allPosts' )->name('allpostsadminsubscribers');
    ...
    Route::post('/admin/allpostsallorder','OrderController@allPosts' )->name('allpostsallorder');
    Route::post('/admin/allpostspendingorder','OrderController@allPostspending' )->name('allpostspendingorder');
    Route::post('/admin/allpostsprocessingorder','OrderController@allPostsprocessing' )->name('allpostsprocessingorder');
    Route::post('/admin/allpostscompletedorder','OrderController@allPostscompleted' )->name('allpostscompletedorder');
    Route::post('/admin/allpostscanceldeorder','OrderController@allPostscancelde' )->name('allpostscanceldeorder');
    ...
    Route::post('/admin/importcategory','CategoryController@import')->name('importcategory');
